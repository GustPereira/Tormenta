...
export const RACES: RaceDef[] = [
  { id: 'humano', name: 'Humano', attributeModifiers: {}, freeChoice: { count: 3, value: 1 } },
  ...
  { id: 'kliren', name: 'Kliren', attributeModifiers: { inteligencia: 2, carisma: 1, forca: -1 } },
  { id: 'medusa', name: 'Medusa', attributeModifiers: { destreza: 2, carisma: 1 } },
  { id: 'osteon', name: 'Osteon', attributeModifiers: { constituicao: -1 }, freeChoice: { count: 3, value: 1, except: ['constituicao'] } },
